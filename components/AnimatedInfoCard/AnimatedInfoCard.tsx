...
const AnimatedInfoCard = ({ description, desktopImage, mobileImage, tabletImage, title }: Props) => (
    <main class="flex flex-col gap-20 px-4 mb-20 lg:mb-44 lg:flex-row lg:px-0 lg:max-w-[1054px] lg:mx-auto">
        ...
        <Image
            ...
            class="hidden rounded-2xl lg:block transition-shadow duration-500 hover:shadow-infocard-hover"
        />
        <Image
            ...
            class="hidden rounded-2xl sm:block lg:hidden"
        />
        <Image
            ...
            class="rounded-2xl mx-auto sm:hidden"
        />
    </main>
);
