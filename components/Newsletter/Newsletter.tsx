...
const Newsletter = ({ ctaLink, ctaText, description, title }: Props) => (
    <main class="p-8 bg-gradient-to-b from-white from-0% via-green-200 via-[66.13%] to-green-300 to-100%">
        <h1 class="font-poppins font-medium text-[40px]/tight" dangerouslySetInnerHTML={{ __html: title }} />
        <div class="font-poppins font-medium text-base px-5" dangerouslySetInnerHTML={{ __html: description }} />
        <a
